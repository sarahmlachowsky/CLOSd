...
const LoginScreen = ({ onLogin }) => {
  ...
  // If signing up, we want first/last name too
  ...
  try {
    if (isSignup) {
      ...
      // 2) Create a user profile doc in Firestore
